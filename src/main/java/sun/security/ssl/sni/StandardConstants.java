...
public final class StandardConstants {
	 ...
	 * {@link SNIHostName}) in a Server Name Indication (SNI) extension.
	 * <P>
	...
	/**
	 * Set this property to true/false for Allow/Deny clients without SNI
	 * support.
	 * 
	 * The value of this constant is {@value}
	 */
	public static final String ALLOW_WITH_OUT_SNI = "jsse.allowWithoutSNI";

	/**
	 * Set this property to alias name of the certificate that will be served to
	 * non supported clients.
	 * 
	 * The value of this constant is {@value}
	 */
	public static final String DEFAULT_CERTIFICATE_ALIAS = "jsse.defaultCertificateAlias";
}
